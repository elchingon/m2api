...
describe M2api::Dataset do
  let(:dataset) {M2api::Dataset.new M2api::Product}
  context "Initial Dataset" do
    ...
    it "has model" do
      ...
      expect(dataset.model).to eq M2api::Product
    end
  ...
  context "simple name filter" do
    ...
    it "adds filter" do
      expect(name_filter_ds.opts[:filters]).to include M2api::Filter::Eq
    end
  ...
  context "multi filter" do
    ...
    it "contains filter with type Filter::Eq" do
      expect(multi_filter_ds.opts[:filters]).to include M2api::Filter::Eq
    end
  ...
  context "select" do
    ...
    it "adds filter" do
      expect(name_select_ds.opts[:fields]).to be_an_instance_of M2api::Filter::Fields
    end
    ...
    it "adds multiple fields" do
      ...
      expect(multi_field_select_ds.opts[:fields]).to be_an_instance_of M2api::Filter::Fields
